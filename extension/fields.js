...
function aceChooseOption(options, answer, aliases) {
  ...
  // inventing one. "Ashfield" still fails against "Boston", because
  // "ashfield" is not the start of "boston".
  //
...
/* Whether every word of `wanted` starts a word of `text`, in order.
   ...
   "seattle washington united states" holds, and "ashfield" against
