...
var OPTION_CASES = [
  ...
  [["Lakeview, Washington, United States", "Boston, Massachusetts, United States"],
   "Lakeview WA", 0],
  [["Ashfield, Washington, United States", "Boston, Massachusetts, United States"],
   "Ashfield", 0],
  // "ashfield" does not start "boston", so nothing is chosen.
  [["Boston, Massachusetts, United States"], "Ashfield", -1],
